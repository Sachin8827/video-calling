...
export default function Dashboard() {
  ...
  const handleStartCall = (type: "voice" | "video") => {
    ...
    // In a real app, this emits the call to the backend, waits for acceptance, then redirects.
    // For demo purposes, we redirect immediately assuming acceptance logic is handled in the room or via overlay.
